...
<head>
    ...
    <title>Qiraah Online | Ayat Player</title>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Ayat Player</h1>
                                    <!-- breadcrumb Start-->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                            <li class="breadcrumb-item"><a href="ayat-player.php">Ayat Player</a></li> 
                                        </ol>
                                    </nav>
                                    <!-- breadcrumb End -->
                                </div>
                            ...
                            if ($handle = opendir($directory)) {
                                while (($file = readdir($handle)) !== false) {
                                    if ($file != "." && $file != "..") {
                                        ...
                                        echo '<div class="ayat" onclick="playAyat(\'' . $file . '\')">' . $title . '</div>';
                                    }
                                }
                                closedir($handle);
                            }
                           ...
                           <div class="single-footer-caption mb-50">
                               <div class="single-footer-caption mb-30">
                                   ...
                                   <div class="footer-social">
                                       <a href="https://m.facebook.com/profile.php?id=61560685315188"><i class="fab fa-facebook-f"></i></a>
                                       <a href="https://www.linkedin.com/company/qiraah-online/"><i class="fab fa-linkedin-in"></i></a>
                                    </div>
                               </div>
                           </div>
                       </div>
